...
install_Celegans_smartLight(){
  log "Downloading c-elegans_smartLight..."
  cd
  git clone https://github.com/JCPuchalt/c-elegans_smartLight.git
  logRed "Installing Celegans_smartLight..."
...
log ">> cd c-elegans_smartLight"
log ">> sudo ./c-elegans_smartLight"
...
ask_for_Celegans_smartLight_installation(){
  ...
  do
    ...
    case $INPUT_STRING in
      "yes")
        echo "Installing c-elegans_smartLight..."
        install_Celegans_smartLight
        keepLoop=false
        ;;
      "no")
        echo "No c-elegans_smartLight installation!"
        keepLoop=false
        ;;
      *)
        echo "Do you want to install c-elegans_smartLight? yes or no."
        ;;
    esac
   done
}
...
main(){
  ...
  logRed "Do you want to install c-elegans_smartLight? yes or no."
  ask_for_Celegans_smartLight_installation
